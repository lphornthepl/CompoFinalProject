...
public class DataLoader  implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Product product1 = Product.builder().productId("001").productName("Mama").image(imageBaseUrl+"mama.jpg").price(15).amount(1).description("mama").Show(true).build();
        Product product2 = Product.builder().productId("002").productName("Cookie").image(imageBaseUrl+"cookie.jpg").price(10).amount(1).description("Homemade Cookie").Show(true).build();
        Product product3 = Product.builder().productId("003").productName("Lay").image(imageBaseUrl+"lay.jpg").price(25).amount(1).description("Lay Big size").Show(true).build();
        Product product4 = Product.builder().productId("004").productName("Bento").image(imageBaseUrl+"bento.jpg").price(10).amount(1).description("spicy bento").Show(true).build();
        Product product5 = Product.builder().productId("005").productName("Tawan").image(imageBaseUrl+"tawan.jpg").price(20).amount(1).description("tawan original").Show(true).build();
        Product product6 = Product.builder().productId("006").productName("Coke").image(imageBaseUrl+"coke.jpg").price(20).amount(1).description("sugar free coke").Show(true).build();
